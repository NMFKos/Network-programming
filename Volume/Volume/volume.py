...
class VolumeControlLine(tk.Canvas):
    def __init__(self, master=None, **kwargs):
        ...
        self.volume_indicator = self.create_rectangle(20, 5, 180, 15, fill='#6666CC')  # Initial volume indicator
    ...
    def update_volume(self, x):
        ...
        self.set_volume(self.volume / 100)  # Set volume (scale to 0-1)
...
# Load and play music
pygame.mixer.music.load("background_music.mp3")  # Replace with your audio file
...
bg_img = Image.open("bgvolume.jpg")
